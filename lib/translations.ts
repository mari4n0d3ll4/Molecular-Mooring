export const translations = {
  en: {
    ...
    about: "About",
    support: "Support",
    goToLearnTab: "Go to Learn Tab",
    goToPredictTab: "Go to Predict Tab",
  ...
  es: {
    ...
    about: "Acerca de",
    support: "Apoyar",
    goToLearnTab: "Ir a la Pestaña Aprender",
    goToPredictTab: "Ir a la Pestaña Predecir",
    ...
    fullyParallelBetaSheet: "Completamente Lámina β paralela",
    fullyAntiParallelBetaSheet: "Completamente Lámina β antiparalela",
